...
// Mock products for FulFil
const mockProducts = [
    { id: '1', sku: 'FF-001', name: 'Auriculares Bluetooth Premium', brand: 'SoundMax', category: 'Audio', price: 899, stock: 520, synced: true },
    { id: '2', sku: 'FF-002', name: 'Smartwatch Deportivo Pro', brand: 'FitTech', category: 'Wearables', price: 1599, stock: 340, synced: true },
    { id: '3', sku: 'FF-003', name: 'Cargador Inalámbrico 15W', brand: 'PowerUp', category: 'Accesorios', price: 399, stock: 890, synced: true },
    { id: '4', sku: 'FF-004', name: 'Funda Silicona iPhone 15', brand: 'CasePro', category: 'Fundas', price: 299, stock: 1200, synced: false },
    { id: '5', sku: 'FF-005', name: 'Cable USB-C a Lightning 2m', brand: 'ConnectPlus', category: 'Cables', price: 199, stock: 2500, synced: true },
    { id: '6', sku: 'FF-006', name: 'Bocina Portátil Waterproof', brand: 'SoundMax', category: 'Audio', price: 1299, stock: 180, synced: true },
    { id: '7', sku: 'FF-007', name: 'Power Bank 20000mAh', brand: 'PowerUp', category: 'Accesorios', price: 699, stock: 450, synced: false },
    { id: '8', sku: 'FF-008', name: 'Soporte Celular Magnético', brand: 'MountPro', category: 'Accesorios', price: 249, stock: 780, synced: true },
];
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-2 text-sm text-muted">
                ...
                <span>/</span>
                <span className="text-white">FulFil</span>
            </div>

            {/* Page Header */}
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500/20 to-green-600/5 border border-green-500/30 flex items-center justify-center">
                        ...
                        {filteredProducts.map((product) => (
                            <tr key={product.id}>
                                ...
                                <td className="text-right">
                                    <span className={product.stock < 200 ? 'text-warning' : 'text-subtle'}>
